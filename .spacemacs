...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; Set the value of `dotspacemacs-line-numbers' to `relative'
...
before packages are loaded."
  ...
  ;; Add SPC + Arrow keys for window navigation
  ...
  ;; Add SPC d for vertical window split
  (spacemacs/set-leader-keys
    "d" 'split-window-right)


  ;; Add SPC p for horizontal window split and focus
  (spacemacs/set-leader-keys
    "p" 'split-window-below-and-focus)

  ;; Make Dired open files in the same buffer
  (put 'dired-find-alternate-file 'disabled nil)
  (with-eval-after-load 'dired
    (define-key dired-mode-map (kbd "RET") 'dired-find-alternate-file))

  ;; Bind 'o' to open file in new vertical window in Dired
  (with-eval-after-load 'dired
